...
<div id="taskboard-header" class="row wrapper border-bottom white-bg">
    <nav class="navbar border-bottom">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 text-right">
            ...
            <a href="//mantis.avancecommunicatie.nl/my_view_page.php" class="btn btn-sm btn-success nav-btn" style="border-radius: 15px;"><span style="font-size: 1.4em;">Mantis</span> <i class="fa fa-angle-double-right fa-customsize"></i>
            </a>
        </div>
    </nav>
