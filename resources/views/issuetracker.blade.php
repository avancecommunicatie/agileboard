                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="" class="btn btn-primary btn-xs">Nieuwe issue aanmaken</a>
                        </div>
                    </div>
                    <div class="ibox-content">
                        ...
                        <div class="m-b-lg">
                            ...
                            <div class="input-group">
                                <input type="text" placeholder="Doorzoek issues op naam" class=" form-control">
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-white"> Zoeken</button>
                                    </span>
                            </div>
                            <div class="m-t-md">
